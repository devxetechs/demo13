...
class Home(main.Home):
    ...
    def web_login(self, redirect=None, **kw):
        copy_kw = kw.copy()
        GRCSudo = request.env.ref('google_recaptcha.google_recaptcha_config').sudo()
...
class CaptchaValidation(http.Controller):  
    ...
    def google_captcha_validation(self, redirect=None, **kw):
        values = {}
        recaptcha_data = request.env.ref('google_recaptcha.google_recaptcha_config')
        ...
        if not kw.get('g-recaptcha-response') == None:
            ...
            if result['success'] == True:
                recaptcha_data = request.env.ref('google_recaptcha.google_recaptcha_config')
                quote_url =""
                action =  request.env.ref('google_recaptcha.action_google_recaptcha_config')
                menu_id = request.env.ref('google_recaptcha.menu_google_recaptcha_config')
        ...
        return request.render('google_recaptcha.google_captcha_validation', values)
